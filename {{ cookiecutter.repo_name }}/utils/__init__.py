...
def send_line_notification(message):
    line_token = '9IiQzFYm1yh4erTzQWtrK5rjwo6uSKsWGLDea6rGfVE'  # 終わったら無効化する
...
def write_spreadsheet(*args):
    endpoint = 'https://script.google.com/macros/s/AKfycbw3TvzVeGqvoyz3x6uozQISqp4qTbE_-YlzKZ1bopdpiZdA5_M/exec'
